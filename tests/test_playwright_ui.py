...
def _session_metrics_payload() -> dict:
    ...
    return {
        ...
        "response_roll_y": [0.2, 0.22, 0.23, 0.24, 0.24, 0.25, 0.26, 0.26, 0.27],
        "response_roll_left_x": roll_x,
        "response_roll_left_y": [0.18, 0.2, 0.21, 0.22, 0.22, 0.23, 0.24, 0.24, 0.25],
        "response_roll_right_x": roll_x,
        "response_roll_right_y": [0.22, 0.24, 0.25, 0.26, 0.26, 0.27, 0.28, 0.28, 0.29],
